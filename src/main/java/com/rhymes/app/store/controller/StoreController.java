...
public class StoreController {
   ...
   public List<BasketListDto> insertCookieBasket(BasketDto basket, Principal prc,
	   ...
	   if(prc == null) {
            ...
            System.out.println("세션 장바구니리스트 사이즈 : " + cBasketList4.size());
            for (BasketListDto b : cBasketList4) {
            	System.out.println("~~~~~~~~~~~~~~~~~~~~~~");
            	System.out.println("STOCKSEQ : " + b.getStock_seq());
				System.out.println("장바구니 수량 : "+b.getP_quantity());
				System.out.println("상품명 : " + b.getP_name());
				System.out.println("상품사이즈 : " + b.getSize());
				System.out.println("상품가격 : " + b.getP_price());
   ...
   //2.로그인X(비회원)
      ...
      if(session.getAttribute(ip) != null || prc != null) {
    	  System.out.println("장바구니 리스트 사이즈 : " + blist.size());
	      int unitPrice = 0;
	      int basketPcnt = 0;
	      int total_price = 0;
	      int quantity = 0; /*재고수량*/
